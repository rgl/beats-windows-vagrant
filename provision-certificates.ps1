...
$caDirectory = "c:\vagrant\shared\beats-example-ca"
$caPathPrefix = "$caDirectory\beats-example-ca"
$caCommonName = 'Beats Example CA'
...
# New-ClientCertificate 'beats.example.com'
# # import the client certificate to be able to use a browser to access the
# # exporters endpoints that are behind the reverse-proxy https.
# Import-PfxCertificate `
#     -FilePath "$caDirectory\beats.example.com-client-key.p12" `
